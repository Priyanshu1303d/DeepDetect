    ...
    <div className="w-full py-10 rounded-tr-3xl rounded-tl-3xl bg-zinc-800">
      ...
      <div className="px-20">
        <div className="cards w-full flex gap-10 mt-5">
          ...
          >
            <h1 className="absolute flex overflow-hidden text-[#CDEA68] left-full -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-9xl font-['Neue_Montreal'] tracking-tight">
          ...
          <motion.div
            ...
            className="cardcontainer relative w-1/2 h-[75vh]"
          >
            <h1 className="absolute flex overflow-hidden text-[#CDEA68] right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-9xl font-['Neue_Montreal'] tracking-tight">
